...
public class RegistrationServlet extends HttpServlet {
	...
	private void persist(User user) throws ServletException {
		...
		try (Connection con = ds.getConnection();
			PreparedStatement pstmt = con.prepareStatement(
					"INSERT INTO user (username, email, password, departement, isadmin, isverified) VALUES (?,?,?,?,?,?)")){ 
					//generatedKeys)){
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		user.setIsverified(Boolean.valueOf(request.getParameter("isverified")));
		...
		// Redirect to the index page later or think login page
